...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-assemble/node_modules/assemble-core/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-assemble/node_modules/assemble-core/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-assemble/node_modules/assemble-core/</a> &#187; index.js</div>
</div>
<div class="body">
...
function Assemble(options) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof Assemble)) {
<span class="cstat-no" title="statement not covered" >    return new Assemble(options);</span>
  }
